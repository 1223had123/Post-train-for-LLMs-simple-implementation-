...
ds = load_dataset(
    "parquet",
    data_files={
        "test": str(ROOT_DIR / "data/bbh_logical/test-00000-of-00001.parquet"),
    },
...
question = ds["test"]["input"]
answer = ds["test"]["target"]
...
print(f"bbh_logical(acc):{correct_count / test_len}")
