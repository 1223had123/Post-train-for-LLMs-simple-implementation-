...
def parse_args():
    ...
    parser.add_argument("--test-file", default=str(ROOT_DIR / "data/bbh_logical/test-00000-of-00001.parquet"))
...
def main():
    ...
    dataset = ds["test"].shuffle(seed=args.seed)
    ...
    print(model.device)
    print(f"split=test, size={len(dataset)}, num_samples={args.num_samples}")
